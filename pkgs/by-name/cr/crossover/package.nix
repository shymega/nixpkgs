...
let
  ...
  src = rec {
      x86_64-linux = fetchurl {
        url = "https://media.codeweavers.com/pub/crossover/cxlinux/demo/crossover-25.1.0-1.rpm";
        hash = "sha256-RJrHiaRulLmlveNnme6v4ZwrRpXiZ6MrVcNu7EPFdEM=";
      };
      x86_64-darwin = fetchzip {
        url = "https://media.codeweavers.com/pub/crossover/cxmac/demo/crossover-25.1.1.zip";
